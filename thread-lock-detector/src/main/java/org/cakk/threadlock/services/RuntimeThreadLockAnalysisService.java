...
public class RuntimeThreadLockAnalysisService {

  private final Project project;

  public RuntimeThreadLockAnalysisService(Project project) {
  ...
  private int getLineNumber(PsiElement element) {
    return ReadAction.compute(() -> {
      ...
      com.intellij.openapi.editor.Document doc = FileDocumentManager.getInstance()
