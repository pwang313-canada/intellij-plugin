    ...
    patchPluginXml {
        ...
        pluginDescription.set("""
            ...
            <ol>
                <li><strong>Start Monitoring</strong>
                    <ul>
                        <li>In order to monitor remote Java application, add these VM operations</l>
                        <li>-Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=9010 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false</li>
                        <li>Trigger tool window by clicking left-bottom Memory Monitor button</li>
                    </ul>
                </li>
        ...
        changeNotes.set("""
            ...
            <ul>
                ...
                <li>📈 Real-time memory monitoring with heap, young gen, and old gen charts</li>
                <li>🔍 Automatic memory leak detection with configurable thresholds</li>
                <li>🌐 Remote JMX monitoring support</li>
                <li>✅ User-confirmed System.gc() invocation</li>
                <li>🎨 Color-coded toggleable chart views</li>
